...
def serializedATN():
    return [
        ...
        0,4,1,0,22,23,1,0,7,10,1,0,12,15,1,0,16,17,140,0,33,1,0,0,0,2,42,
        ...
        45,5,1,0,0,45,46,5,2,0,0,46,47,5,22,0,0,47,51,5,1,0,0,48,50,5,21,
        0,0,49,48,1,0,0,0,50,53,1,0,0,0,51,49,1,0,0,0,51,52,1,0,0,0,52,54,
        1,0,0,0,53,51,1,0,0,0,54,55,5,3,0,0,55,56,5,21,0,0,56,57,5,3,0,0,
        57,5,1,0,0,0,58,59,5,1,0,0,59,60,5,4,0,0,60,61,5,22,0,0,61,62,5,
        21,0,0,62,63,5,23,0,0,63,64,5,3,0,0,64,7,1,0,0,0,65,66,5,1,0,0,66,
        ...
        0,96,97,5,23,0,0,97,101,5,23,0,0,98,100,5,23,0,0,99,98,1,0,0,0,100,
        ...
        120,5,22,0,0,120,121,3,18,9,0,121,122,5,3,0,0,122,125,1,0,0,0,123,
...
class MyGrammar2Parser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'('", "'declare-fun'", "')'", "'define-const'", 
                     "'assert'", "'distinct'", "'>='", "'<='", "'<'", "'>'", 
                     "'='", "'+'", "'-'", "'/'", "'*'", "'and'", "'or'", 
                     "'check-sat'", "'get-model'", "<INVALID>", "'Int'" ]
    ...
    def comp_formula(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & 12582914) != 0:
                self.state = 86
                self.formula()
                self.state = 91
                self._errHandler.sync(self)
